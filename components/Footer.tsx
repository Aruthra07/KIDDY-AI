...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-white border-t-8 border-brand-dark pt-16 pb-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-display text-sm font-semibold text-gray-600 leading-relaxed">
          ...
          <div className="flex flex-col gap-4 font-display">
            ...
            <ul className="space-y-2 text-sm font-bold text-gray-600">
              ...
              <li><Link href="/resources" className="hover:text-brand-blue transition-colors">Worksheets Library</Link></li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border-t-3 border-brand-dark/15 pt-8 pb-10">
          <div className="flex items-center gap-3 bg-brand-sky/40 border-2 border-brand-dark/10 rounded-2xl p-3 font-display">
            <div className="p-2 bg-white border border-brand-dark/20 rounded-xl text-brand-blue"><Mail size={18} /></div>
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase">Write to Us</p>
              <p className="text-xs font-extrabold text-brand-dark">support@kiddyai.com</p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-brand-sky/40 border-2 border-brand-dark/10 rounded-2xl p-3 font-display">
            <div className="p-2 bg-white border border-brand-dark/20 rounded-xl text-brand-pink"><Phone size={18} /></div>
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase">Ring a Bell</p>
              <p className="text-xs font-extrabold text-brand-dark">+91 8345672345</p>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-brand-sky/40 border-2 border-brand-dark/10 rounded-2xl p-3 font-display">
            <div className="p-2 bg-white border border-brand-dark/20 rounded-xl text-brand-green"><MapPin size={18} /></div>
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase">Launchpad HQ</p>
        ...
        <div className="border-t-3 border-brand-dark/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-bold font-display text-gray-500">
          <div className="flex items-center gap-1.5">
            <span>© {new Date().getFullYear()} Kiddy AI. Built with</span>
            <Heart size={12} className="text-brand-pink fill-brand-pink stroke-brand-dark" />
            <span>for school students everywhere.</span>
          </div>
